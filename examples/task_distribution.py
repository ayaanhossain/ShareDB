...
def para_conv(inDB_path, outDB_path, exec_id, num_proc):
    '''
    This procedure computes the convolution of input vector pairs
    stored in a ShareDB instance located at inDB_path, and writes
    the results in a ShareDB instance located in outDB_path.
    '''
    ...
    outDB = ShareDB(
        ...
        map_size=10**7)   # And we estimate to require ~10MB for results
...
def main():
    ...
    # Join all processes and cleanup
    task_streamer.join()
